...
public class AtualizarFuncionario extends javax.swing.JFrame {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        try{
            ...
            Funcionario funcionario = funcionarioDAO.pesquisarFuncionarioPorID(idFuncionario);
        ...
        if (funcionario != null) {
            ...
            JOptionPane.showMessageDialog(null, "Funcionário não encontrado. Verifique se o ID é válido.");
        }
            
            
        }   catch(SQLException erro){
                JOptionPane.showMessageDialog(null, "Atualizar Funcionario: " + erro);
                return;
