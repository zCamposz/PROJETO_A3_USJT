...
public class CriarFuncionario extends javax.swing.JFrame {
    ...
    public CriarFuncionario(Funcionario funcionario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Criar Funcionario");
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        try{
            ...
            funcionario.setId_login(usuarioDAO.getNextId());
            ...
            funcionarioDAO.cadastrarFuncionario(funcionario);
                ...
                JOptionPane.showMessageDialog(null, "Cadastrar Funcionario: " + erro);
                return;
        }   catch (NumberFormatException erro){
                JOptionPane.showMessageDialog(null, "Campo de Idade está incorreto, por favor digite um numero.");
                return;
        }
        JOptionPane.showMessageDialog(null, "Cadastrado o funcionario com sucesso!");
            this.setVisible(false);
            GerenciarFuncionario gerenciarFuncionario = new GerenciarFuncionario(funcionario);
            gerenciarFuncionario.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CriarFuncionario(funcionario).setVisible(true);
            }
        });
    }
