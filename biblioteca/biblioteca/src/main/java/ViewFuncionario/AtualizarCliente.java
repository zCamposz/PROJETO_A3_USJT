...
public class AtualizarCliente extends javax.swing.JFrame {
    ...
    public AtualizarCliente(Funcionario funcionario, Cliente cliente) {
        initComponents();
        ...
        campoIdade.setText(String.valueOf(cliente.getIdade())); 
    }
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        if (cliente != null) {
            ...
            JOptionPane.showMessageDialog(null, "Cliente não encontrado. Verifique se o ID é válido.");
        }
            
            
        }   catch(SQLException erro){
                JOptionPane.showMessageDialog(null, "Atualizar Cliente: " + erro);
                return;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AtualizarCliente(funcionario,  cliente).setVisible(true);
            }
        });
    }
